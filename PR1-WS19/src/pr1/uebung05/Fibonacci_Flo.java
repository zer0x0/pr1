...
public class Fibonacci_Flo {
	...
	/**
	 * Methode calculateFibonacci Berechnung der Fibonacci Folge falls
	 * Übergabeparameter == 1 -> so steht an erster Stelle des paramArrays eine 0;
	 * falls Übergabeparameter > 1 -> berechnung von FibonacciFolge startet; falls
	 * Übergabeparameter != gültig -> throw new PRException("Eingabe ungültig / HaltStop! Nicht mit negativen Zahlen!");
